...
<meta name="keywords" content="雷科,雷射,雷射設備,laser" />
<meta name="description" content="雷科,雷射,雷射設備,laser,Laser Scriber">
<meta name="copyright" content="雷科股份有限公司版權所有" />
<meta name="robots" content="all" />
<meta name="Distribution" content="Taiwan">
<meta name="msvalidate.01" content="EE65CEECBEA8E128651C6BA7A7E63F9D" />
<title>雷科股份有限公司|雷射</title>  
...
#head{width:1004px; height:364px; background:url(<?php echo $upload; ?>/laser/0206110021.jpg) no-repeat;}
...
<param name="movie" value="<?php echo $upload; ?>/0206190013.swf" />
<param name="quality" value="high" />
<param name="wmode" value="transparent" />
<embed src="<?php echo $upload; ?>/laser/0206190013.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="970" height="215" wmode="transparent"></embed>
</object>
...
<tr>
<td valign="middle">
<a href='index.php?au_id=1' style='font-size:10pt;'><img src="<?php echo $upload; ?>/laser/0206200007.png" onMouseOver="this.src='<?php echo $upload; ?>/laser/0206200011.png'" onMouseOut="this.src='<?php echo $upload; ?>/laser/0206200007.png'" alt="服務項目" /></a>
...
<tr>
<td valign="middle">
<a href='index.php?au_id=10' style='font-size:10pt;'><img src="<?php echo $upload; ?>/laser/0206190033.png" onMouseOver="this.src='<?php echo $upload; ?>/laser/0206200009.png'" onMouseOut="this.src='<?php echo $upload; ?>/laser/0206190033.png'" alt="聯絡我們" /></a>
...
<tr>
<td valign="middle">
<a href='index5497.html?au_id=16&amp;sub_id=40' style='font-size:10pt;'><img src="../laser/0206190041.png" onMouseOver="this.src='/laser/laser/0206190040.png'" onMouseOut="this.src='/laser/0206190041.png'" alt="檔案下載" /></a>
...
<tr>
<td valign="middle">
<a href='javascript: void(0)' target='_main'><img src="upload/0207170008.png" alt="A級會員檔案下載專區" /></a>
...
<tr>
<td valign="middle">
<a href='javascript: void(0)' target='_main'><img src="upload/0207170006.png" alt="B級會員檔案下載專區" /></a>
...
<tr>
<td valign="middle">
<a href='javascript: void(0)' target='_main'><img src="upload/0207170007.png" alt="C級會員檔案下載專區" /></a>
...
<ul id="navmenu-v" style="margin-left:0px;">
  <ul>
    <li style='padding:0;'><a style='padding:0;'><img src='<?php echo $upload; ?>/laser/0206110016.png' alt='被動元件產業' /></a>
      <ul style="width:225px;float:left;margin: 0 0 0 50px;">
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=2'>Laser Trimmer-Thick Film Trimmer</a>
          <!--<ul></ul>-->
        </li>
        
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=3'>Laser Trimmer-Thin Film Trimmer</a>
         <!-- <ul></ul>-->
        </li>
        
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=4'>Laser Trimmer-Functional Trimmer</a>
          <!--<ul></ul>-->
        </li>
        
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=5'>Laser Scribing</a>
          <!--<ul></ul>-->
        </li>
      </ul>
    </li>
    
    <li style='padding:0;'><a style='padding:0;'><img src='<?php echo $upload; ?>/laser/0206110017.png' alt='PCB/FPCB產業' /></a>
      <ul style="width:225px;float:left;margin: 0 0 0 50px;">
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=6'>FPCB</a>
          <!--<ul></ul>-->
        </li>
        
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=7'>PCB</a>
         <!-- <ul></ul>-->
        </li>
        
      </ul>
    </li>
    <li style='padding:0;'><a style='padding:0;'><img src='<?php echo $upload; ?>/laser/0206110018.png' alt='半導體產業' /></a>
      <ul style="width:225px;float:left;margin: 0 0 0 50px;">
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=8'>Laser marking</a>
         <!-- <ul></ul>-->
        </li>
      </ul>
    </li>
    <li style='padding:0;'><a style='padding:0;'><img src='<?php echo $upload; ?>/laser/0206110019.png' alt='光電產業' /></a>
      <ul style="width:225px;float:left;margin: 0 0 0 50px;">
        <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
          <a href='index.php?au_id=9'>LED substrate drilling</a>
          <!--<ul></ul>-->
        </li>
      </ul>
    </li>
