...
<meta name="keywords" content="雷科,Embossed carrier tape,Cover Tape,Tape & Reel,紙帶,打孔,捲帶機,測包機,SMD,PCT,ECT" />
<meta name="description" content="雷科,Embossed carrier tape,Cover Tape,Tape & Reel,紙帶,打孔,捲帶機,測包機,SMD,PCT,ECT">
<meta name="copyright" content="雷科股份有限公司版權所有" />
<meta name="robots" content="all" />
<meta name="Distribution" content="Taiwan">
<meta name="msvalidate.01" content="EE65CEECBEA8E128651C6BA7A7E63F9D" />
<title>雷科股份有限公司|SMD</title>  
...
#head{width:1004px; height:364px; background:url(<?php echo $upload; ?>/smd/0208020042.jpg) no-repeat;}
...
<div id="hd_logo">
  <!--<a href="default.asp"><img src="<?php echo $upload; ?>/smd/0206190008.jpg" width="970" height="215" /></a>   -->
</div>
...
<tr>
<td valign="middle">
<a href='index.php?au_id=1' style='font-size:10pt;'><img src="<?php echo $upload; ?>/smd/0206200006.png" onMouseOver="this.src='<?php echo $upload; ?>/smd/0206200015.png'" onMouseOut="this.src='<?php echo $upload; ?>/smd/0206200006.png'" alt="服務項目" /></a>
...
<tr>
<td valign="middle">
<a href='index.php?au_id=13' style='font-size:10pt;'><img src="<?php echo $upload; ?>/smd/0206190022.png" onMouseOver="this.src='<?php echo $upload; ?>/smd/0206200017.png'" onMouseOut="this.src='<?php echo $upload; ?>/smd/0206190022.png'" alt="聯絡我們" /></a>
...
<tr>
<td valign="middle">
<a href='indexb74e.html?au_id=15&amp;sub_id=39' style='font-size:10pt;'><img src="<?php //echo $upload; ?>/smd/0206190023.png" onMouseOver="this.src='<?php //echo $upload; ?>/smd/0206200018.png'" onMouseOut="this.src='<?php //echo $upload; ?>/smd/0206190023.png'" alt="檔案下載" /></a>
...
<tr>
<td valign="middle">
<a href='javascript: void(0)' target='_main'><img src="<?php //echo $upload; ?>/smd/0207170002.png" alt="A級會員檔案下載專區" /></a>
...
<tr>
<td valign="middle">
<a href='javascript: void(0)' target='_main'><img src="upload/0207170003.png" alt="B級會員檔案下載專區" /></a>
...
<tr>
<td valign="middle">
<a href='javascript: void(0)' target='_main'><img src="upload/0207170004.png" alt="C級會員檔案下載專區" /></a>
...
<ul id="navmenu-v" style="margin-left:0px;">
  <ul>
    <li style='padding:0;'>
      <a style='padding:0;'><img src='<?php echo $upload; ?>/smd/0206190003.png' alt='SMD產品' /></a>
        <ul style="width:225px;float:left;margin: 0 0 0 50px;">
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=2'><?php echo $lang['un_punched_paper_carrier_tape']; ?> 
            </a>
            <!--<ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=3'><?php echo $lang['pre_punched_paper_carrier_tape']; ?> </a>
            <!--<ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=4'><?php echo $lang['top_bottom_tapes']; ?></a>
           <!-- <ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=5'><?php echo $lang['bottom_tapes']; ?></a>
            <!--<ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=6'><?php echo $lang['embossed_carrier_tape']; ?></a>
            <!--<ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=7'><?php echo $lang['embossed_cover_tape']; ?></a>
            <!--<ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=8'><?php echo $lang['plastic_reel']; ?></a>
            <!--<ul></ul>-->
          </li>
        </ul>
    </li>
    <li style='padding:0;'>
      <a style='padding:0;'><img src='<?php echo $upload; ?>/smd/0206190004.png' alt='SMD製程設備' /></a>
        <ul style="width:225px;float:left;margin: 0 0 0 50px;">
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=9'><?php echo $lang['winding_machine']; ?></a>
            <!--<ul></ul>-->
          </li>
           <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=10'><?php echo $lang['punching_machine']; ?></a>
            <!--<ul></ul>-->
          </li>
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=11'><?php echo $lang['tapping_machine']; ?></a>
            <!--<ul></ul>-->
          </li>
        </ul>
    </li>
    <li style='padding:0;'>
      <a style='padding:0;'><img src='<?php echo $upload; ?>/smd/0206190038.png' alt='SMD製程備品' /></a>
        <ul style="width:225px;float:left;margin: 0 0 0 50px;">
          <li style="list-style-image:url(/website/upload/cht/2017pro_btnicon.gif);">
            <a href='index.php?au_id=12'><?php echo $lang['processing_related_spare_parts']; ?></a>
           <!-- <ul></ul>-->
          </li>
        </ul>
    </li>
